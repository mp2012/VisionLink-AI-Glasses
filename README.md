...
| **视觉采集模块** | ![Astra Plus 深度摄像头](images/1%20(7).jpg) | **Orbbec Astra Plus 3D 深度摄像头** 支持 RGB + 深度双模态感知，GStreamer MJPG pipeline 接入，高精度避障。 |
...
| AI 分辨率 | 448px | 288px |
| 摄像头 | DSHOW, ID=1 | GStreamer MJPG / V4L2, 自动遍历 |
| TTS | PowerShell SAPI5 | edge-tts (微软神经网络语音) |
| 音频设备 | 默认 | USB Audio (plughw:0,0) |
| UI | 完整面板 | 自动适配无头 |
